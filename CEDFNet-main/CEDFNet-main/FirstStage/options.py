import os
import torch
#在服务器跑的时候就不用，现在用这个主要是为了在windows调试的时候模拟服务器命令行输入命令，要根据实际修改这里
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--nepoch', type=int, default=20000, help='training epochs')
        parser.add_argument('--train_workers', type=int, default=10, help='train_dataloader workers')
        parser.add_argument('--eval_workers', type=int, default=10, help='eval_dataloader workers')
        parser.add_argument('--dataset', type=str, default ='LSUI')
        parser.add_argument('--pretrain_weights',type=str, default='../CheckPoint/model_best_stage1.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--arch', type=str, default ='CBformer',  help='archtechture')
        ...
        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='../CheckPoint/logs/stage1',  help='save dir')
        ...
        parser.add_argument('--train_dir', type=str, default ='/data2/CarnegieBin_data/Kashing/EnhanceUf/LSUI_SOTA/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='/data2/CarnegieBin_data/Kashing/dataset/UIEB/val',  help='dir of train data')
